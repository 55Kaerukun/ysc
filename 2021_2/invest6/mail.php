...
$require = array('貴社名','本社所在地','tel','Email','ご相談内容');
...
$refrom_name = "株式会社ワイズシー";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせありがとうございます（無料経営相談）";
...
1〜3営業日以内に、弊社よりご返信させていただきます。
どうぞよろしくお願いします。

-----------------------------------
不動産の個人向け・法人向けコンサルティング 
株式会社ワイズシー
https://ysc-inc.net/
